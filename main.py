...
AnswerPaths = {
  "FoundationsI":{
    "Number":["optionsCheckboxes[0][]=option1&optionsCheckboxes[0][]=option2&optionsCheckboxes[0][]=option3&optionsCheckboxes[0][]=option4&quizType[0][]=multimultiplechoice&quizValidate[0][]=148&quizID=148&user=1&module=30&format=s&currentLesson=463&timeOnCur=" + randint(4,20) + "&confidenceValue=3", "optionsRadios[0][]=option1&quizType[0][]=multiplechoice&quizValidate[0][]=149&quizID=149&user=1&module=30&format=s&currentLesson=463&timeOnCur=" + randint(4,20) + "&confidenceValue=3", "ended=1&user=1&module=30&section=463"],

    "SymbolsAndMeaning":["optionsCheckboxes[0][]=option2&optionsCheckboxes[0][]=option4&quizType[0][]=multimultiplechoice&quizValidate[0][]=150&quizID=150&user=1&module=30&format=s&currentLesson=464&timeOnCur=" + randint(4,20) + "&confidenceValue=3", "optionsCheckboxes[0][]=option2&quizType[0][]=multimultiplechoice&quizValidate[0][]=151&quizID=151&user=1&module=30&format=s&currentLesson=464&timeOnCur=" + randint(4,20) + "&confidenceValue=3", "optionsRadios[0][]=option3&quizType[0][]=multiplechoice&quizValidate[0][]=152&optionsRadios[1][]=option1&quizType[1][]=multiplechoice&quizValidate[1][]=152&quizID=152&user=1&module=30&format=s&currentLesson=464&timeOnCur=" + randint(4,20) + "&confidenceValue=3", "optionsCheckboxes[0][]=option1&optionsCheckboxes[0][]=option2&optionsCheckboxes[0][]=option3&optionsCheckboxes[0][]=option4&quizType[0][]=multimultiplechoice&quizValidate[0][]=153&quizID=153&user=1&module=30&format=s&currentLesson=464&timeOnCur=" + randint(4,20) + "&confidenceValue=3", "optionsCheckboxes[0][]=option2&optionsCheckboxes[0][]=option4&quizType[0][]=multimultiplechoice&quizValidate[0][]=154&quizID=154&user=1&module=30&format=s&currentLesson=464&timeOnCur=" + randint(4,20) + "&confidenceValue=3", "optionsCheckboxes[0][]=option1&optionsCheckboxes[0][]=option2&optionsCheckboxes[0][]=option3&optionsCheckboxes[0][]=option5&optionsCheckboxes[0][]=option7&optionsCheckboxes[0][]=option8&quizType[0][]=multimultiplechoice&quizValidate[0][]=155&quizID=155&user=1&module=30&format=s&currentLesson=464&timeOnCur=" + randint(4,20) + "&confidenceValue=3", "optionsDropdown[0][]=%E2%89%A1&quizType[0][]=dropdown&quizValidate[0][]=156&optionsDropdown[1][]=%E2%89%A1&quizType[1][]=dropdown&quizValidate[1][]=156&optionsDropdown[2][]=%3D&quizType[2][]=dropdown&quizValidate[2][]=156&optionsDropdown[3][]=%E2%89%A1&quizType[3][]=dropdown&quizValidate[3][]=156&optionsCheckboxes[4][]=option1&optionsCheckboxes[4][]=option3&quizType[4][]=multimultiplechoice&quizValidate[4][]=156&quizID=156&user=1&module=30&format=s&currentLesson=464&timeOnCur=" + randint(4,20) + "&confidenceValue=3", "optionsCheckboxes[0][]=option1&quizType[0][]=multimultiplechoice&quizValidate[0][]=157&quizID=157&user=1&module=30&format=s&currentLesson=464&timeOnCur=" + randint(4,20) + "&confidenceValue=3", "ended=1&user=1&module=30&section=464"],
